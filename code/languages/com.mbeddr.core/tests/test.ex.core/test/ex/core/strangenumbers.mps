...
<model modelUID="r:e1ddbc52-57cf-4d4e-8072-be35ab4f9c57(test.ex.core.strangenumbers)">
  ...
  <root id="1054289341113476050">
    <node role="contents" roleId="x27k.6437088627575722833" type="x27k.Function" typeId="x27k.6437088627575724001" id="1054289341113476308">
      ...
      <node role="body" roleId="x27k.4185783222026475860" type=".com.mbeddr.core.statements.structure.StatementList" id="1054289341113476309">
        <node role="statements" type="x27k.ReturnStatement" typeId="x27k.8967919205527146149" id="1054289341113476315">
          <node role="expression" roleId="x27k.8967919205527146150" type=".com.mbeddr.core.unittest.structure.ExecuteTestExpression" id="1054289341113476316">
      ...
      <node role="type" roleId="mj1l.318113533128716676" type="mj1l.Int32tType" typeId="mj1l.8463282783691618440" id="5708867820622277862" />
      <node role="arguments" roleId="x27k.5708867820623310661" type="x27k.Argument" typeId="x27k.7892328519581704407" id="1054289341113476312">
        <property name="name" nameId="tpck.1169194664001" value="args" />
        <node role="type" roleId="mj1l.318113533128716676" type="yq40.ArrayType" typeId="yq40.5679441017214012545" id="5708867820621171203">
    ...
    <node role="contents" roleId="x27k.6437088627575722833" type=".com.mbeddr.core.unittest.structure.TestCase" id="1054289341113476298">
      <property name="exported" value="true" />
      <property name="name" value="testHex" />
      <node role="body" type=".com.mbeddr.core.statements.structure.StatementList" id="1054289341113476052">
        <node role="statements" type=".com.mbeddr.core.statements.structure.LocalVariableDeclaration" id="1054289341113476055">
          <property name="name" value="x" />
          <node role="init" type="mj1l.HexNumberLiteral" typeId="mj1l.1054289341113450444" id="1054289341113476058">
            <property name="value" nameId="mj1l.1054289341113450445" value="1" />
          </node>
          <node role="type" type="mj1l.UnsignedInt8tType" typeId="mj1l.8463282783691618461" id="236363977594764405">
            <property name="volatile" nameId="mj1l.2941277002448691247" value="false" />
            <property name="const" nameId="mj1l.2941277002445651368" value="false" />
          </node>
        </node>
        <node role="statements" type=".com.mbeddr.core.statements.structure.LocalVariableDeclaration" id="1054289341113476060">
          <property name="name" value="y" />
          <node role="init" type="mj1l.HexNumberLiteral" typeId="mj1l.1054289341113450444" id="1054289341113476063">
            <property name="value" nameId="mj1l.1054289341113450445" value="a" />
          </node>
          <node role="type" type="mj1l.UnsignedInt8tType" typeId="mj1l.8463282783691618461" id="236363977594764406">
            <property name="volatile" nameId="mj1l.2941277002448691247" value="false" />
            <property name="const" nameId="mj1l.2941277002445651368" value="false" />
          </node>
        </node>
        <node role="statements" type=".com.mbeddr.core.unittest.structure.AssertStatement" id="1054289341113476300">
          ...
          <node role="expr" type="mj1l.EqualsExpression" typeId="mj1l.8860443239512129322" id="1054289341113476303">
            ...
            <node role="left" roleId="mj1l.8860443239512128064" type="mj1l.PlusExpression" typeId="mj1l.5763383285156373013" id="1054289341113496394">
              <node role="left" roleId="mj1l.8860443239512128064" type=".com.mbeddr.core.statements.structure.LocalVarRef" id="1054289341113496397">
                <link role="var" targetNodeId="1054289341113476055" resolveInfo="x" />
              </node>
              <node role="right" roleId="mj1l.8860443239512128065" type=".com.mbeddr.core.statements.structure.LocalVarRef" id="1054289341113476302">
                <link role="var" targetNodeId="1054289341113476060" resolveInfo="y" />
              </node>
            </node>
          </node>
        </node>
    ...
    <node role="contents" roleId="x27k.6437088627575722833" type=".com.mbeddr.core.unittest.structure.TestCase" id="938100142480316954">
      <property name="exported" value="true" />
      <property name="name" value="testOctal" />
      <node role="body" type=".com.mbeddr.core.statements.structure.StatementList" id="938100142480316955">
        <node role="statements" type=".com.mbeddr.core.statements.structure.LocalVariableDeclaration" id="938100142480316957">
          <property name="name" value="x" />
          <node role="init" type="mj1l.OctalNumberLiteral" typeId="mj1l.938100142480245061" id="938100142480371041">
            <property name="value" nameId="mj1l.938100142480245062" value="7" />
          </node>
          <node role="type" type="mj1l.Int8tType" typeId="mj1l.8463282783691618426" id="5083029923012081046" />
        </node>
        <node role="statements" type=".com.mbeddr.core.statements.structure.LocalVariableDeclaration" id="938100142480371043">
          <property name="name" value="y" />
          <node role="init" type="mj1l.OctalNumberLiteral" typeId="mj1l.938100142480245061" id="938100142480371046">
            <property name="value" nameId="mj1l.938100142480245062" value="1" />
          </node>
          <node role="type" type="mj1l.Int8tType" typeId="mj1l.8463282783691618426" id="5083029923012081095" />
        </node>
        <node role="statements" type=".com.mbeddr.core.unittest.structure.AssertStatement" id="938100142480371048">
          ...
          <node role="expr" type="mj1l.EqualsExpression" typeId="mj1l.8860443239512129322" id="938100142480371055">
            ...
            <node role="left" roleId="mj1l.8860443239512128064" type="mj1l.PlusExpression" typeId="mj1l.5763383285156373013" id="938100142480371051">
              <node role="left" roleId="mj1l.8860443239512128064" type=".com.mbeddr.core.statements.structure.LocalVarRef" id="938100142480371050">
                <link role="var" targetNodeId="938100142480316957" resolveInfo="x" />
              </node>
              <node role="right" roleId="mj1l.8860443239512128065" type=".com.mbeddr.core.statements.structure.LocalVarRef" id="938100142480371054">
                <link role="var" targetNodeId="938100142480371043" resolveInfo="y" />
              </node>
            </node>
          </node>
        </node>
    ...
    <node role="contents" roleId="x27k.6437088627575722833" type=".com.mbeddr.core.unittest.structure.TestCase" id="1054289341113524549">
      <property name="exported" value="true" />
      <property name="name" value="testBinary" />
      <node role="body" type=".com.mbeddr.core.statements.structure.StatementList" id="1054289341113524550">
        <node role="statements" type=".com.mbeddr.core.statements.structure.LocalVariableDeclaration" id="1054289341113524552">
          <property name="name" value="x" />
          <node role="init" type="mj1l.BinaryNumberLiteral" typeId="mj1l.1054289341113496566" id="1054289341113524557">
            <property name="value" nameId="mj1l.1054289341113496567" value="1001" />
          </node>
          <node role="type" type="mj1l.Int8tType" typeId="mj1l.8463282783691618426" id="5083029923012080922" />
        </node>
        <node role="statements" type=".com.mbeddr.core.statements.structure.LocalVariableDeclaration" id="1054289341113524559">
          <property name="name" value="y" />
          <node role="init" type="mj1l.BinaryNumberLiteral" typeId="mj1l.1054289341113496566" id="1054289341113524562">
            <property name="value" nameId="mj1l.1054289341113496567" value="1" />
          </node>
          <node role="type" type="mj1l.Int8tType" typeId="mj1l.8463282783691618426" id="5083029923012080729" />
        </node>
        <node role="statements" type=".com.mbeddr.core.unittest.structure.AssertStatement" id="1054289341113524564">
          ...
          <node role="expr" type="mj1l.EqualsExpression" typeId="mj1l.8860443239512129322" id="1054289341113524571">
            ...
            <node role="left" roleId="mj1l.8860443239512128064" type="mj1l.PlusExpression" typeId="mj1l.5763383285156373013" id="1054289341113524567">
              <node role="left" roleId="mj1l.8860443239512128064" type=".com.mbeddr.core.statements.structure.LocalVarRef" id="1054289341113524566">
                <link role="var" targetNodeId="1054289341113524552" resolveInfo="x" />
              </node>
              <node role="right" roleId="mj1l.8860443239512128065" type=".com.mbeddr.core.statements.structure.LocalVarRef" id="1054289341113524570">
                <link role="var" targetNodeId="1054289341113524559" resolveInfo="y" />
              </node>
            </node>
          </node>
        </node>
  ...
  <root id="1054289341113496293">
    <node role="binaries" roleId="51wr.5046689135694070731" type="51wr.Executable" typeId="51wr.5046689135693761554" id="1054289341113496294">
      ...
      <node role="referencedModules" roleId="51wr.5046689135693761559" type="51wr.ModuleRef" typeId="51wr.7717755763392524107" id="1054289341113496296">
