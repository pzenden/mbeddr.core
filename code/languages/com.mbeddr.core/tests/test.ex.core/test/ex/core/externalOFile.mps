...
<model modelUID="r:2e0033ed-8d27-4fa2-8dad-e6bd6189da28(test.ex.core.externalOFile)">
  ...
  <root id="5275554368891504428">
    <node role="contents" roleId="x27k.6437088627575722833" type=".com.mbeddr.core.unittest.structure.TestCase" id="7646082028326282929">
      <property name="name" value="addNumbers" />
      <property name="exported" value="true" />
      <node role="body" type=".com.mbeddr.core.statements.structure.StatementList" id="7646082028326282930">
        <node role="statements" type=".com.mbeddr.core.statements.structure.LocalVariableDeclaration" id="7646082028326282931">
          <property name="name" value="x" />
          <node role="init" type="mj1l.PlusExpression" typeId="mj1l.5763383285156373013" id="7646082028326282933">
          ...
          <node role="type" type="mj1l.Int8tType" typeId="mj1l.8463282783691618426" id="5083029923012081075" />
        </node>
        <node role="statements" type=".com.mbeddr.core.unittest.structure.AssertStatement" id="7646082028326282936">
          ...
          <node role="expr" type="mj1l.EqualsExpression" typeId="mj1l.8860443239512129322" id="7646082028326282937">
            <node role="left" roleId="mj1l.8860443239512128064" type=".com.mbeddr.core.statements.structure.LocalVarRef" id="7646082028326282938">
              <link role="var" targetNodeId="7646082028326282931" resolveInfo="x" />
              <node role="smodelAttribute" type=".com.mbeddr.core.unittest.structure.ReportNodeAnnotation" id="7646082028326282939">
        ...
        <node role="statements" type=".com.mbeddr.core.unittest.structure.AssertStatement" id="7526178759919974666">
        ...
        <node role="statements" type=".com.mbeddr.core.statements.structure.LocalVariableDeclaration" id="7646082028326282941">
          <property name="name" value="y" />
          <node role="init" type="x27k.FunctionCall" typeId="x27k.5950410542643524492" id="7646082028326282943">
            <link role="function" roleId="x27k.5950410542643524493" targetNodeId="5275554368891504432" resolveInfo="add" />
          ...
          <node role="type" type="mj1l.Int8tType" typeId="mj1l.8463282783691618426" id="5083029923012081464" />
        </node>
        <node role="statements" type=".com.mbeddr.core.unittest.structure.AssertStatement" id="7646082028326282946">
          ...
          <node role="expr" type="mj1l.EqualsExpression" typeId="mj1l.8860443239512129322" id="7646082028326282947">
            <node role="left" roleId="mj1l.8860443239512128064" type=".com.mbeddr.core.statements.structure.LocalVarRef" id="7646082028326282948">
              <link role="var" targetNodeId="7646082028326282941" resolveInfo="y" />
            </node>
        ...
        <node role="statements" type=".com.mbeddr.core.unittest.structure.AssertStatement" id="7646082028326282950">
        ...
        <node role="statements" type=".com.mbeddr.core.unittest.structure.AssertStatement" id="7646082028326282958">
    ...
    <node role="contents" roleId="x27k.6437088627575722833" type="x27k.Function" typeId="x27k.6437088627575724001" id="3134547887598558630">
      ...
      <node role="body" roleId="x27k.4185783222026475860" type=".com.mbeddr.core.statements.structure.StatementList" id="3134547887598558631">
        <node role="statements" type="x27k.ReturnStatement" typeId="x27k.8967919205527146149" id="4803851085316453345">
          <node role="expression" roleId="x27k.8967919205527146150" type=".com.mbeddr.core.unittest.structure.ExecuteTestExpression" id="5275554368891505778">
  ...
  <root id="5275554368891504532">
    ...
    <node role="configurationItems" roleId="vs0r.4459718605982007338" type=".com.mbeddr.core.util.structure.ReportingConfiguration" id="4459718605982728860">
