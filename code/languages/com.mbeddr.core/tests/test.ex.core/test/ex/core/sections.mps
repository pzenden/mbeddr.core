...
<model modelUID="r:da916eac-c856-4c12-bbef-80eb91c66d5a(test.ex.core.sections)">
  ...
  <root id="5947739078127610434">
    ...
    <node role="contents" roleId="x27k.6437088627575722833" type="x27k.Section" typeId="x27k.6512473996287153137" id="5947739078127622596">
      ...
      <node role="contents" roleId="x27k.6512473996287153139" type=".com.mbeddr.core.unittest.structure.TestCase" id="5947739078127622607">
        ...
        <node role="body" type=".com.mbeddr.core.statements.structure.StatementList" id="5947739078127622609">
          <node role="statements" type=".com.mbeddr.core.statements.structure.ExpressionStatement" id="22102029902643372">
            <node role="expr" type="mj1l.AssignmentExpr" typeId="mj1l.22102029902365709" id="22102029902643373">
          ...
          <node role="statements" type=".com.mbeddr.core.unittest.structure.AssertStatement" id="5947739078127622617">
    ...
    <node role="contents" roleId="x27k.6437088627575722833" type="x27k.Section" typeId="x27k.6512473996287153137" id="5947739078127635309">
      ...
      <node role="contents" roleId="x27k.6512473996287153139" type="x27k.Function" typeId="x27k.6437088627575724001" id="5947739078127635310">
        ...
        <node role="body" roleId="x27k.4185783222026475860" type=".com.mbeddr.core.statements.structure.StatementList" id="5947739078127635311">
          <node role="statements" type="x27k.ReturnStatement" typeId="x27k.8967919205527146149" id="5947739078127635319">
    ...
    <node role="contents" roleId="x27k.6437088627575722833" type="x27k.Function" typeId="x27k.6437088627575724001" id="5947739078127635368">
      ...
      <node role="body" roleId="x27k.4185783222026475860" type=".com.mbeddr.core.statements.structure.StatementList" id="5947739078127635369">
        <node role="statements" type="x27k.ReturnStatement" typeId="x27k.8967919205527146149" id="5947739078127635378">
          <node role="expression" roleId="x27k.8967919205527146150" type=".com.mbeddr.core.unittest.structure.ExecuteTestExpression" id="5947739078127635379">
  ...
  <root id="5947739078127635361">
    ...
    <node role="configurationItems" roleId="vs0r.4459718605982007338" type=".com.mbeddr.core.util.structure.ReportingConfiguration" id="5947739078127635363">
