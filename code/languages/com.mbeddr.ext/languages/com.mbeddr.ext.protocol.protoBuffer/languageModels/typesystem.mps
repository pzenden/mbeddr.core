...
<model modelUID="r:6b2f0660-4b24-48b8-b84d-ff77423d4457(com.mbeddr.ext.protocol.protoBuffer.typesystem)">
  ...
  <root type="tpd4.SubtypingRule" typeId="tpd4.1175147670730" id="8786192108439926221" nodeInfo="ng">
    ...
    <node role="body" roleId="tpd4.1175147624276" type="tpee.StatementList" typeId="tpee.1068580123136" id="8786192108439926222" nodeInfo="sn">
      <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="8786192108439926839" nodeInfo="nn">
        <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="8786192108439937322" nodeInfo="nn">
          <node role="operand" roleId="tpee.1197027771414" type="tpd4.ApplicableNodeReference" typeId="tpd4.1174650418652" id="8786192108439926838" nodeInfo="nn">
            <link role="applicableNode" roleId="tpd4.1174650432090" targetNodeId="8786192108439926224" resolveInfo="protoBufferMessageType" />
          </node>
          <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="8786192108439942485" nodeInfo="nn">
      ...
      <node role="statement" roleId="tpee.1068581517665" type="tp2q.ForEachStatement" typeId="tp2q.1153943597977" id="6634804589736167595" nodeInfo="nn">
        ...
        <node role="inputSequence" roleId="tp2q.1153944424730" type="tpee.DotExpression" typeId="tpee.1197027756228" id="6634804589736167603" nodeInfo="nn">
          <node role="operand" roleId="tpee.1197027771414" type="tpd4.ApplicableNodeReference" typeId="tpd4.1174650418652" id="8786192108440926586" nodeInfo="nn">
            <link role="applicableNode" roleId="tpd4.1174650432090" targetNodeId="8786192108440908154" resolveInfo="message" />
          </node>
          <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkListAccess" typeId="tp25.1138056282393" id="8786192108440931877" nodeInfo="nn">
            <link role="link" roleId="tp25.1138056546658" targetNodeId="hqp9.8786192108438605840" />
          </node>
        </node>
