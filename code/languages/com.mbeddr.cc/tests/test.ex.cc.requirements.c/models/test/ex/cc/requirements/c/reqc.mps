...
<model modelUID="r:e0e9d1a4-0ca8-44b9-95b2-560017317dec(test.ex.cc.requirements.c.reqc)">
  ...
  <root id="3534497005926839232">
    ...
    <node role="contents" roleId="x27k.6437088627575722833" type="x27k.Function" typeId="x27k.6437088627575724001" id="3534497005926839292">
      ...
      <node role="body" roleId="x27k.4185783222026475860" type="c4fa.StatementList" typeId="c4fa.4185783222026475861" id="3534497005926839294">
        <node role="statements" roleId="c4fa.4185783222026475862" type="x27k.ReturnStatement" typeId="x27k.8967919205527146149" id="3534497005926839298">
          <node role="expression" roleId="x27k.8967919205527146150" type=".com.mbeddr.cc.requirements.c.structure.RCaclulationCall" id="3534497005926984612">
            <link role="calculation" targetNodeId="3534497005926953363" resolveInfo="rebatedPrice" />
            <node role="actuals" type="x27k.ArgumentRef" typeId="x27k.2093108837558505658" id="3534497005926989993">
    ...
    <node role="smodelAttribute" roleId="tpck.5169995583184591170" type=".com.mbeddr.cc.requirements.structure.ReqModuleRefAttribute" id="3534497005926839285">
  ...
  <root id="3534497005926839233">
    <node role="cls" type=".com.mbeddr.cc.requirements.structure.DefaultRequirementsClass" id="3348865852193241108" />
    <node role="abstract" type="vs0r.TextBlock" typeId="vs0r.8375407818529178006" id="3348865852193241105">
    ...
    <node role="requirements" type=".com.mbeddr.cc.requirements.structure.Requirement" id="3534497005926839234">
      ...
      <node role="doc" type=".com.mbeddr.cc.requirements.structure.ReqDocParagraph" id="4559893981897094919">
        <node role="contents" type=".com.mbeddr.doc.structure.TextParagraph" id="4559893981897094920">
          <node role="text" type="87nw.Text" typeId="87nw.2557074442922380897" id="4559893981897094921">
    ...
    <node role="requirements" type=".com.mbeddr.cc.requirements.structure.Requirement" id="3534497005926953361">
      ...
      <property name="proseText" value="" />
      <node role="doc" type=".com.mbeddr.cc.requirements.structure.ReqDocParagraph" id="4559893981897095818">
        <node role="contents" type=".com.mbeddr.doc.structure.TextParagraph" id="4559893981897095819">
          <node role="text" type="87nw.Text" typeId="87nw.2557074442922380897" id="4559893981897095820">
    ...
    <node role="requirements" type=".com.mbeddr.cc.requirements.structure.Requirement" id="3562422675424166429">
      ...
      <node role="doc" type=".com.mbeddr.cc.requirements.structure.ReqDocParagraph" id="4559893981897094907">
        <node role="contents" type=".com.mbeddr.doc.structure.TextParagraph" id="4559893981897094908">
          <node role="text" type="87nw.Text" typeId="87nw.2557074442922380897" id="4559893981897094909">
      ...
      <node role="additionalData" type=".com.mbeddr.cc.requirements.c.structure.RCalculation" id="3562422675424166437">
        ...
        <node role="expr" type="k146.GSwitchExpression" typeId="k146.6209595569797561318" id="3562422675424166451">
